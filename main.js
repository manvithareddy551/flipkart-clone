...
function slidimg(){
    ...
    if(wdt <= 768){
        for(var i = 0; i < imgid.length; i++){
            if(i == 0)
            imgid[i].innerHTML = '<img src="slider1.jpg" alt="img" class="slide" style="width:100%">';
            if(i == 1)
            imgid[i].innerHTML = '<img src="slider2.jpg" alt="img" class="slide" style="width:100%">';
            if(i == 2)
            imgid[i].innerHTML = '<img src="slider3.jpg" alt="img" class="slide" style="width:100%">';
            if(i == 3)
            imgid[i].innerHTML = '<img src="slider5.jpg" alt="img" class="slide" style="width:100%">';
            if(i == 4)
            imgid[i].innerHTML = '<img src="slider6.jpeg" alt="img" class="slide" style="width:100%">';
        }
    }
}
function minus(){
